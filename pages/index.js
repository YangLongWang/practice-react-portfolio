...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Longyang Portfolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl">Longyang Wang</h2>
            <h3 className="text-2xl py-2 md:text-3xl">Developer and designer.</h3>
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto">Emerging full-stack web developer who is a certificate in full-stack web development from the University of Toronto Bootcamp. Learned new skills in CSS, JavaScript, Python, Node.js, and responsive web design from Bootcamp. Be called an innovative practitioner and problem solver passionate about developing apps. Strong execution and coordination skills in teamwork, can quickly promote the plan development.</p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800">Emerging full-stack web developer who is a certificate in <span className="text-teal-500"> full-stack web development</span> from the University of Toronto Bootcamp. Learned new skills in <span className="text-teal-500"> CSS, JavaScript, Python, Node.js, and responsive web design</span> from Bootcamp.</p>
            <p className="text-md py-2 leading-8 text-gray-800">Be called an innovative practitioner and problem solver passionate about developing apps. Strong execution and coordination skills in teamwork, can quickly promote the plan development.</p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              <Image className="mx-auto" src={design} alt="" width={100} height={100} />
              <h3 className="text-lg font-medium pt-8 pb-2">Beautiful Designs</h3>
              <p className="py-2">Strong execution and coordination skills in teamwork, can quickly promote the plan development.</p>
